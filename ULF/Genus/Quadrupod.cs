...
namespace ULF
{
	public static class Quadrupod
	{
		public static void Auto(string hostis){

			// boar
			Primor.Hostis[hostis].PV[0] = 50;
      Primor.Hostis[hostis].PM[0] = 200;
      Primor.Hostis[hostis].PV[1]=Primor.Hostis[hostis].PV[0];
      Primor.Hostis[hostis].PM[1]=Primor.Hostis[hostis].PM[0];

      Primor.Hostis[hostis].Vigor[0] = 15;
      Primor.Hostis[hostis].Dexteritate[0] = 10;
      Primor.Hostis[hostis].Conditio[0] = 15;
      Primor.Hostis[hostis].Intelligentia[0] = 5;
      Primor.Hostis[hostis].Sapientia[0] = 10;
      Primor.Hostis[hostis].Virtus();

      Primor.Hostis[hostis].Altitudo=40;
      Primor.Hostis[hostis].Latitudo=30;
      ...
      Primor.Hostis[hostis].Planitia[1]=4000;
      Primor.Hostis[hostis].Caput[0]=Math.Round((Primor.Hostis[hostis].Altitudo/2)*1, 2);
      ...
      Primor.Hostis[hostis].Collum[0]=Math.Round((Primor.Hostis[hostis].Crassitudo[0]/16)*1, 2);
      ...
      Primor.Hostis[hostis].Cor[0]=Math.Round((Primor.Hostis[hostis].Crassitudo[0]/16)*1, 2);
      ...
      Primor.Hostis[hostis].Tergum[0]=Math.Round((Primor.Hostis[hostis].Crassitudo[0]/4)*3.5, 2);
      ...
      Primor.Hostis[hostis].Bracchium[0]=Math.Round((Primor.Hostis[hostis].Altitudo/2)*1, 2);
      ...
      Primor.Hostis[hostis].Stomachus[0]=Math.Round((Primor.Hostis[hostis].Crassitudo[0]/4)*3, 2);
