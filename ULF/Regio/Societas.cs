...
namespace ULF
{
    ...
    public string[] praesto = new string[20];
		public Societas(string nomen="", Dictionary<string, string> ample=null, int lum=0, int noc=86400, params string[] prae) : base(nomen, ample, lum, noc){
      this.praesto=prae;
    }
    ...
    public static Societas Advenire(string soc){
      Societas MageGuild = new Societas("Mage Guild", new Dictionary<string, string>{{"Emerald Village","100300"}}, 18000, 75600, new string[]{
